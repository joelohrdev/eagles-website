...
class StoreCampRegistrationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'emergency_contact_phone' => ['required', 'string', $this->phoneRule()],
    ...
    {
        return $this->phoneMessages('phone', 'emergency_contact_phone');
    }
    ...
    {
        $this->normalizePhoneNumbers('phone', 'emergency_contact_phone');
    }
}
